...
<div class="container">
    <div class="row">
        <div class="card">
            <div class="card-header">{{ __('Обновление ресторана') }}</div>

            <div class="card-body">
                <form enctype="multipart/form-data" method="POST" action="/shawarma/{{$shawarma->id}}/update">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="text" value="{{$shawarma->title}}" class="form-control" name="title" required autofocus>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" value="{{$shawarma->price_from}}" name="price_from" required autofocus>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" value="{{$shawarma->price_to}}" name="price_to" required autofocus>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" value="{{$shawarma->longitude}}" name="longitude" required autofocus>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" value="{{$shawarma->latitude}}" name="latitude" required autofocus>
                        </div>
                    </div>
                    <div class="col-md-4 ">
